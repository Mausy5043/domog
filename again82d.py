...
def do_markdown(flock, fdata):
  ...
  with open(fdata, 'a') as f:
    f.write('![A GNUplot image should be here: day21.png](img/day71.png)\n')
    f.write('![A GNUplot image should be here: day21.png](img/day72.png)\n')
    f.write('![A GNUplot image should be here: day73.png](img/day73.png)\n')
    f.write('![A GNUplot image should be here: day79.png](img/day79.png)\n')
